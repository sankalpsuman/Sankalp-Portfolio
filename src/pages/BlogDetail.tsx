               ...
               <article className="space-y-12">
                  <header className="space-y-8">
                      <div className="space-y-6">
                         <div className="flex flex-wrap gap-3">
                            <span className="px-4 py-1.5 bg-blue-600/10 border border-blue-500/20 text-blue-400 rounded-xl text-[10px] font-black uppercase tracking-widest">{tCategory}</span>
                            <span className="px-4 py-1.5 bg-white/5 rounded-xl text-[10px] font-black uppercase tracking-widest text-gray-500 flex items-center gap-2 border border-white/5">
                               <Clock className="w-3.5 h-3.5" /> {t('blog_detail.read_time')}
                            </span>
                         </div>
                         <h1 className="text-4xl md:text-7xl font-black tracking-tighter leading-[1.05] text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-100 to-white/40 uppercase">{tTitle}</h1>
                         <div className="flex items-center gap-6 text-gray-500 text-[10px] border-b border-white/5 pb-10 font-black uppercase tracking-widest">
                            <div className="flex items-center gap-3">
                               <img src="https://ui-avatars.com/api/?name=Sankalp+Suman&background=2563eb&color=fff" className="w-10 h-10 rounded-full border-2 border-blue-500/20" alt="Author" />
                               <span className="text-white">Sankalp Suman</span>
                            </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                     <div className="lg:col-span-8">
                        <div className="prose prose-invert prose-blue prose-lg max-w-none prose-headings:font-black prose-headings:tracking-tighter prose-headings:uppercase prose-a:text-blue-400 prose-img:rounded-[2rem] prose-img:shadow-2xl prose-p:leading-relaxed prose-p:text-gray-300">
                           <ReactMarkdown remarkPlugins={[remarkGfm, remarkBreaks]}>{tContent}</ReactMarkdown>
                        </div>
